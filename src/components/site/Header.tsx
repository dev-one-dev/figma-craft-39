  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#flagCircle)">
        ...
        <path
          fill="#D52B1E"
          d="M12 4L12.8 6.8 14.5 5.8 13.5 8.5 16.5 9 14.5 11 17 12 14 13.5 15.5 16 12.7 14.8 12.7 20.5 11.3 20.5 11.3 14.8 8.5 16 10 13.5 7 12 9.5 11 7.5 9 10.5 8.5 9.5 5.8 11.2 6.8Z"
        />
      </g>
    </svg>
  );
