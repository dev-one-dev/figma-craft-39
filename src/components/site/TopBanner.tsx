      ...
      <div className="relative mx-auto flex w-full max-w-[960px] flex-col items-center gap-6 sm:gap-8">
        <div ref={loopRef} className="relative flex w-full flex-col items-center">
          <img
            ...
            draggable={false}
          />
          <DashedLoopCa key={`loop-${loopKey}`} className="pointer-events-none absolute left-1/2 bottom-[2%] hidden w-[239px] -translate-x-[340px] lg:block" />
          <img
            key={`trial-${loopKey}`}
            src={trialCa}
            alt="7 days free trial available"
            className="pointer-events-none absolute left-1/2 -bottom-[80px] hidden w-[118px] -translate-x-[420px] select-none opacity-0 [animation:loopFadeIn_0.6s_ease-out_1.4s_forwards] lg:block"
            draggable={false}
          />
          <a
            href="#apps"
